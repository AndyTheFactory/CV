...
class Gradient{
    ...
    public void doGradient(BufferedImage img){
        ...
        Lab5Helper.writeImageFile(img, CannyTask.file, "gray");
        Lab5Helper.writeImageFile(gradientImgX, CannyTask.file, "gradientX");
        Lab5Helper.writeImageFile(gradientImgY, CannyTask.file, "gradientY");
        ...
        Lab5Helper.writeImageFile(edge1, CannyTask.file, "edge_raw");
        ...
        Lab5Helper.writeImageFile(edge1, CannyTask.file, "edge1");
        ...
        Lab5Helper.writeImageFile(edge2, CannyTask.file, "edge2");
        ...
        Lab5Helper.writeImageFile(edge2, CannyTask.file, "edge1_connected");
        ...
        Lab5Helper.writeImageFile(edge2, CannyTask.file, "edge2_connected");
    }
